...
PORTFOLIO_ITEMS = [
    
    {
        'id': 1,
        'title': 'Ecom Web',
        'description': 'E-commerce website built with Flask — features product listing, cart, and payment integration. (Repository: ravulaarundhathi/ecom_web)',
        'image': 'project_ecom.jpg',
        'technologies': ['Python', 'Flask', 'HTML', 'CSS', 'Stripe'],
        'github': 'https://github.com/ravulaarundhathi/ecom_web'
    },
    {
        'id': 2,
        'title': 'Blog app using tkinter',
        'description': 'A simple blog application built using tkinter GUI Framework; includes the blog app and multiple Tkinter practice projects.',
        'image': 'project_tkinter.jpg',
        'technologies': ['Python', 'Tkinter', 'GUI'],
        'github': 'https://github.com/ravulaarundhathi/blog_App-tkinter_ex-'
    },
    {
        'id': 3,
        'title': 'Telecom Customer Churn Prediction',
        'description': 'Mini project (B.Tech): Built machine learning models (KNN, Random Forest) to predict telecom customer churn. Focused on data cleaning, feature selection, and model evaluation. (Repository: ravulaarundhathi/Mini_project)',
        'image': 'project_churn.jpg',
        'technologies': ['Python', 'Pandas', 'scikit-learn', 'Machine Learning'],
        'github': 'https://github.com/ravulaarundhathi/Mini_project'
    },
]
...
@app.route('/project/tkinter')
def project_tkinter():
    """Static detail page for the Tkinter GUI course project"""
    return render_template('project_tkinter.html')
